...
var import_immer5 = __toModule(Immer);
__reExport(exports, __toModule(Redux));
var import_immer6 = __toModule(Immer);
var import_reselect2 = __toModule(Reselect);
// src/createDraftSafeSelector.ts
var import_immer = __toModule(Immer);
var import_reselect = __toModule(Reselect);
...
var import_redux2 = __toModule(Redux);
// src/devtoolsExtension.ts
var import_redux = __toModule(Redux);
...
var import_redux_thunk = __toModule(ReduxThunk);
// src/utils.ts
var import_immer2 = __toModule(Immer);
...
function freezeDraftable(val) {
    return isDraftable(val) ? (0, import_immer2.default)(val, function () {
    }) : val;
}
...
var import_immer3 = __toModule(Immer);
// src/mapBuilders.ts
...
function createReducer(initialState, mapOrBuilderCallback, actionMatchers, defaultCaseReducer) {
    ...
    function reducer(state, action) {
        ...
        return caseReducers.reduce(function (previousState, caseReducer) {
            if (caseReducer) {
/*                 return (0, Immer.isDraftable)(val) ? (0, import_immer2.default)(val, function () {
                }) : val; */
                if ((0, isDraft)(previousState)) {
                ...
                else if (!(0, isDraftable)(previousState)) {
...
var import_immer4 = __toModule(Immer);
